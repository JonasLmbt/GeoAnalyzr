...
import { renderAdminAnalysisWidget } from "./widgets/adminAnalysisWidget";
...
export async function renderDashboard(
  ...
  async function renderWidget(widget: WidgetDef): Promise<HTMLElement> {
    ...
    if (widget.type === "admin_analysis") return await renderAdminAnalysisWidget(semantic, widget, overlay, baseRows as any);
